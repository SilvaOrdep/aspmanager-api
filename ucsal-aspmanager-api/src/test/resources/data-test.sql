...
ALTER TABLE instituicoes_ensino ALTER COLUMN id RESTART WITH 2;
ALTER TABLE escolas ALTER COLUMN id RESTART WITH 5;
ALTER TABLE usuarios ALTER COLUMN id RESTART WITH 3;
ALTER TABLE professores ALTER COLUMN id RESTART WITH 2;
